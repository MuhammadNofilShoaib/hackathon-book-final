# ROS 2 Nodes, Topics, Services & Actions (Beginner Level)
...
# Beginner Explanation: ROS 2 Node for Physical AI Communication Patterns
import rclpy
...
class CommunicationPatternsNode(Node):
    def __init__(self):
        ...
        # Create QoS profiles
# Beginner Explanation: Create QoS profiles
...
# Beginner Explanation: TOPIC PUBLISHER - Publish robot status
        self.status_publisher = self.create_publisher(
            String, '/robot_status', 10)

        # TOPIC SUBSCRIBER - Subscribe to sensor data
# Beginner Explanation: TOPIC SUBSCRIBER - Subscribe to sensor data
...
# Beginner Explanation: SERVICE SERVER - Handle immediate requests
...
# Beginner Explanation: ACTION SERVER - Handle long-running tasks
...
# Beginner Explanation: Timer for periodic status updates
...
# Beginner Explanation: Process IMU data for balance, orientation, etc.
...
# Beginner Explanation: Check if we can accept the goal
...
# Beginner Explanation: Initialize feedback and result messages
        feedback_msg = Fibonacci.Feedback()
        result_msg = Fibonacci.Result()

        # Simulate navigation progress
# Beginner Explanation: Simulate navigation progress
        sequence = [0, 1]

        try:
            for i in range(1, goal_handle.request.order):
                # Check if the goal was canceled
# Beginner Explanation: Check if the goal was canceled
                ...
                # Update feedback
# Beginner Explanation: Update feedback
                sequence.append(sequence[i] + sequence[i-1])
                feedback_msg.sequence = sequence
                goal_handle.publish_feedback(feedback_msg)

                # Log progress
# Beginner Explanation: Log progress
...
# Beginner Explanation: Sleep to simulate actual navigation time
                from time import sleep
                sleep(0.5)

                # Check for emergency during navigation
# Beginner Explanation: Check for emergency during navigation
                if self.is_emergency:
                    goal_handle.abort()
...
# Beginner Explanation: Complete the goal successfully
            goal_handle.succeed()
            result_msg.sequence = sequence
...
# Beginner Explanation: Wait for action server
        self.navigation_action_client.wait_for_server()

        # Send goal with feedback callback
# Beginner Explanation: Send goal with feedback callback
...
# Beginner Explanation: Create and run the communication patterns node

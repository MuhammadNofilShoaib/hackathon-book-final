# Gazebo Simulation for Physical AI (Beginner Level)
...
# Beginner Explanation: ROS 2 Node for Gazebo Simulation Control
import rclpy
...
# Beginner Explanation: Publishers for commanding the simulated robot
        self.cmd_vel_pub = self.create_publisher(Twist, '/cmd_vel', 10)
        self.joint_cmd_pub = self.create_publisher(JointState, '/joint_commands', 10)

        # Subscribers for sensor data from simulation
# Beginner Explanation: Subscribers for sensor data from simulation
...
# Beginner Explanation: Service clients for Gazebo control
...
# Beginner Explanation: Wait for Gazebo services to be available
...
# Beginner Explanation: Process IMU data for balance and orientation
...
# Beginner Explanation: Process camera data for vision-based tasks
...
# Beginner Explanation: Example: Send velocity commands to the simulated robot
        cmd = Twist()

        # Simple oscillating motion for demonstration
# Beginner Explanation: Simple oscillating motion for demonstration
...
# Beginner Explanation: Example: Publish joint commands if needed
...
# Beginner Explanation: Example: Spawn a simple box obstacle
        box_model = """
        <sdf version="1.6">
...
# Beginner Explanation: Publisher for robot commands
        self.cmd_vel_pub = self.create_publisher(Twist, '/cmd_vel', 10)

        # Subscriber for robot pose feedback
# Beginner Explanation: Subscriber for robot pose feedback
        self.pose_sub = self.create_subscription(
            Pose, '/robot_pose', self.pose_callback, 10)

        # Timer for testing
# Beginner Explanation: Timer for testing
...
# Beginner Explanation: Test sequence: move forward, turn, move forward again
...
# Beginner Explanation: Create simulation control node
    sim_node = GazeboSimulationNode()

    # Setup the simulation environment
# Beginner Explanation: Setup the simulation environment
    sim_node.setup_simulation_environment()

    # Create test node
# Beginner Explanation: Create test node

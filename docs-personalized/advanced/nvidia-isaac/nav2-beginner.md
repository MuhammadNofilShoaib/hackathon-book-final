# Navigation and Path Planning with Nav2 for Humanoid Robots (Beginner Level)
...
# Beginner Explanation: Nav2 configuration and server setup for humanoid robots
import rclpy
...
# Beginner Explanation: Create action server for navigation
...
# Beginner Explanation: TF buffer for transforms
...
# Beginner Explanation: Humanoid-specific parameters
...
# Beginner Explanation: Costmap for humanoid navigation
...
# Beginner Explanation: Update costmap with laser data
...
# Beginner Explanation: Check balance if navigating
        if self.navigation_active:
...
# Beginner Explanation: Check if robot is within balance limits
...
# Beginner Explanation: Validate goal for humanoid constraints
        ...
        try:
            # Plan global path
# Beginner Explanation: Plan global path
            ...
            # Publish global path
# Beginner Explanation: Publish global path
            self.global_path_pub.publish(global_path)

            # Execute navigation
# Beginner Explanation: Execute navigation
    ...
    def is_valid_humanoid_goal(self, goal):
        ...
        # Get current pose
# Beginner Explanation: Get current pose
        current_pose = self.get_current_pose()
        if current_pose is None:
            return False

        # Check distance (humanoid robots typically have limited range per session)
# Beginner Explanation: Check distance (humanoid robots typically have limited range per session)
...
# Beginner Explanation: Check if goal is in navigable space considering humanoid dimensions
...
# Beginner Explanation: In a real implementation, this would use a path planning algorithm
        # like A* or Dijkstra with humanoid-specific cost functions
# Beginner Explanation: like A* or Dijkstra with humanoid-specific cost functions
        # For this example, we'll simulate the path planning
# Beginner Explanation: For this example, we'll simulate the path planning

        # Get path from costmap considering humanoid dimensions
# Beginner Explanation: Get path from costmap considering humanoid dimensions
...
# Beginner Explanation: Convert to ROS Path message
            ros_path = Path()
...
# Beginner Explanation: Follow the global path with local obstacle avoidance
...
# Beginner Explanation: Small delay to allow for movement
            time.sleep(0.1)

        # Final check if we reached the goal
# Beginner Explanation: Final check if we reached the goal
        current_pose = self.get_current_pose()
        if current_pose:
...
# Beginner Explanation: In a real implementation, this would use local planners like DWA or Teb
        # For humanoid robots, considering balance and step constraints
# Beginner Explanation: For humanoid robots, considering balance and step constraints
        # For this example, we'll return a simple path
# Beginner Explanation: For this example, we'll return a simple path
...
# Beginner Explanation: This would interface with the humanoid's walking controller
        # For this example, we'll simulate the locomotion
# Beginner Explanation: For this example, we'll simulate the locomotion
...
# Beginner Explanation: Calculate direction and distance
...
# Beginner Explanation: Calculate orientation for movement
            yaw = math.atan2(dy, dx)

            # Generate footstep plan for this segment
# Beginner Explanation: Generate footstep plan for this segment
...
# Beginner Explanation: Execute footsteps (in real implementation, send to walking controller)
            for footstep in footsteps:
                if self.cancel_requested:
                    return False

                # In real implementation, this would send commands to the robot's
# Beginner Explanation: In real implementation, this would send commands to the robot's
                # walking controller to execute the footstep
# Beginner Explanation: walking controller to execute the footstep
                self.execute_footstep(footstep)

                # Wait for step completion
# Beginner Explanation: Wait for step completion
                time.sleep(0.5)
...
# Beginner Explanation: Calculate the path vector
        dx = end[0] - start[0]
        dy = end[1] - start[1]
        total_distance = math.sqrt(dx*dx + dy*dy)

        # Generate footsteps at regular intervals based on step size
# Beginner Explanation: Generate footsteps at regular intervals based on step size
...
# Beginner Explanation: Alternate between left and right foot
...
# Beginner Explanation: In a real implementation, this would send commands to the
        # humanoid's walking controller
# Beginner Explanation: humanoid's walking controller
        cmd_msg = String()
...
# Beginner Explanation: Initialize costmap (0 = free, 255 = occupied)
...
# Beginner Explanation: Convert laser ranges to occupancy grid
...
# Beginner Explanation: Mark cell as occupied
                self.set_cost(x, y, 255)

                # Inflate around obstacle for humanoid safety
# Beginner Explanation: Inflate around obstacle for humanoid safety
...
# Beginner Explanation: Only increase cost, don't decrease
...
# Beginner Explanation: Simple A* implementation for demonstration
        # In real implementation, would use more sophisticated path planners
# Beginner Explanation: In real implementation, would use more sophisticated path planners
        # that consider humanoid kinematic constraints
# Beginner Explanation: that consider humanoid kinematic constraints

        # Convert to grid coordinates
# Beginner Explanation: Convert to grid coordinates
        start_grid = (
...
# Beginner Explanation: Check if start and goal are valid
...
# Beginner Explanation: For simplicity, return direct path (in real implementation, use A*)
        path = [start, goal]
        return path
...
# Beginner Explanation: Simple line-of-sight check
        dx = end[0] - start[0]
        dy = end[1] - start[1]
        distance = math.sqrt(dx*dx + dy*dy)
...
# Beginner Explanation: For local planning, consider immediate obstacles
        # In real implementation, would use local planners like DWA or Teb
# Beginner Explanation: In real implementation, would use local planners like DWA or Teb
        return [start, goal]
...
# Beginner Explanation: Nav2 behavior trees and recovery behaviors for humanoid robots
import rclpy
from rclpy.node import Node
from nav2_msgs.action import NavigateToPose
...
# Beginner Explanation: Create action client to interact with Nav2 server
...
# Beginner Explanation: Publishers for commands and status
...
# Beginner Explanation: Humanoid-specific parameters
        ...
        # Recovery behaviors
# Beginner Explanation: Recovery behaviors
...
# Beginner Explanation: Check for nearby obstacles
        if msg.ranges:
...
# Beginner Explanation: Extract roll and pitch from orientation
        quat = [msg.orientation.x, msg.orientation.y, msg.orientation.z, msg.orientation.w]
        roll, pitch, _ = self.quaternion_to_euler(quat)

        # Check balance thresholds
# Beginner Explanation: Check balance thresholds
...
# Beginner Explanation: Analyze scan to find safe passage
...
# Beginner Explanation: Look for gaps in obstacles
        safe_angles = []
...
# Beginner Explanation: If we found safe angles, navigation can continue
...
# Beginner Explanation: Try each recovery behavior in sequence
...
# Beginner Explanation: For humanoid, backup might involve stepping backwards
        # In simulation, we'll send a reverse velocity command
# Beginner Explanation: In simulation, we'll send a reverse velocity command
        cmd = Twist()
        cmd.linear.x = -0.2  # Back up slowly
        cmd.angular.z = 0.0

        # Execute for 2 seconds
# Beginner Explanation: Execute for 2 seconds
...
# Beginner Explanation: Turn in place to reassess the situation
        cmd = Twist()
        cmd.linear.x = 0.0
        cmd.angular.z = 0.5  # Turn at 0.5 rad/s

        # Execute for 2 seconds (about 90 degree turn)
# Beginner Explanation: Execute for 2 seconds (about 90 degree turn)
        start_time = time.time()
        while time.time() - start_time < 2.0:
            if not self.balance_ok:
                self.stop_navigation()
...
# Beginner Explanation: Move in a small random pattern to get unstuck
        import random

        # Random direction and distance
# Beginner Explanation: Random direction and distance
...
# Beginner Explanation: Calculate time to travel the distance
...
# Beginner Explanation: In a real implementation, we would send the goal to Nav2
        # and monitor the execution with our safety checks
# Beginner Explanation: and monitor the execution with our safety checks
        # For this example, we'll simulate the navigation loop
# Beginner Explanation: For this example, we'll simulate the navigation loop

        start_time = time.time()
        while self.navigation_state == 'NAVIGATING':
            # Check if navigation is safe to continue
# Beginner Explanation: Check if navigation is safe to continue
            if not self.check_navigation_safety():
                # Try recovery behaviors
# Beginner Explanation: Try recovery behaviors
...
# Beginner Explanation: Publish status
            ...
            # Small delay
# Beginner Explanation: Small delay
            time.sleep(0.1)

            # Simulate reaching goal after some time
# Beginner Explanation: Simulate reaching goal after some time
...
# Beginner Explanation: Convert theta to quaternion
...
# Beginner Explanation: In a real implementation, we would send this goal to the Nav2 server
        # For this example, we'll start our simulated navigation
# Beginner Explanation: For this example, we'll start our simulated navigation
...
# Beginner Explanation: Publishers and subscribers
        self.path_pub = self.create_publisher(String, '/humanoid/planned_path', 10)
        self.laser_sub = self.create_subscription(
            LaserScan, '/scan', self.laser_callback, 10)

        # Path planning parameters
# Beginner Explanation: Path planning parameters
...
# Beginner Explanation: Grid map for path planning
        self.grid_map = None
        self.map_width = 100
        self.map_height = 100
        self.origin_x = 0.0
...
# Beginner Explanation: Convert laser scan to grid map
...
# Beginner Explanation: Convert to grid coordinates
                ...
                if 0 <= grid_x < self.grid_map.shape[1] and 0 <= grid_y < self.grid_map.shape[0]:
                    # Mark as occupied
# Beginner Explanation: Mark as occupied
...
# Beginner Explanation: In a real implementation, this would use advanced path planning
        # algorithms that consider humanoid kinematics and balance
# Beginner Explanation: algorithms that consider humanoid kinematics and balance
        # For this example, we'll implement a basic A* with humanoid constraints
# Beginner Explanation: For this example, we'll implement a basic A* with humanoid constraints

        # Convert start and goal to grid coordinates
# Beginner Explanation: Convert start and goal to grid coordinates
...
# Beginner Explanation: Check if goal is free
        if self.grid_map[goal_grid[1], goal_grid[0]] > 200:
            return None

        # Run A* path planning
# Beginner Explanation: Run A* path planning
        path = self.a_star_search(start_grid, goal_grid)

        if path:
            # Convert back to world coordinates
# Beginner Explanation: Convert back to world coordinates
    ...
    def a_star_search(self, start, goal):
        ...
        while not open_set.empty():
            ...
            if current == goal:
                # Reconstruct path
# Beginner Explanation: Reconstruct path
                path = []
...
# Beginner Explanation: Check if neighbor is passable for humanoid
...
# Beginner Explanation: Create navigation behavior nodes
